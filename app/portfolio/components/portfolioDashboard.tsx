    ...
    <main className="min-h-[calc(100vh-80px)] bg-background px-4 py-6 text-foreground sm:px-6 lg:px-10">
      <div className="mx-auto grid max-w-[1440px] gap-5 lg:grid-cols-[260px_1fr]">
        <PortfolioSidebar
          portfolio={portfolio}
          onDelete={onDelete}
          onOpenPortfolioForm={onOpenPortfolioForm}
        ...
        <section className="space-y-5">
          <section className={panelClass}>
            <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
              <div>
                <p className="text-sm text-chart-muted">Portfolio dashboard</p>

                <h1 className="mt-1 text-3xl font-semibold tracking-tight">
                  {portfolio.icon} {portfolio.name}
                </h1>

                <p className="mt-2 text-sm text-chart-muted">
                  Add coins manually and track what would happen if you owned
                  them.
                </p>
              </div>

              <button className="flex items-center justify-center gap-2 rounded-xl bg-foreground px-5 py-3 text-sm font-semibold text-background transition hover:scale-[1.02] active:scale-[0.98]">
          ...
          <section className={panelClass}>
            <div className="mb-5 flex items-center justify-between">
              ...
              <button className="flex items-center gap-2 rounded-xl bg-foreground px-4 py-2.5 text-sm font-semibold text-background transition hover:scale-[1.02] active:scale-[0.98]">
