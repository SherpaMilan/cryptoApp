  ...
  return (
    <section className="flex min-w-0 items-center gap-3">
          ...
          {portfolios.map((portfolio, index) => {
            ...
            return (
              <div
                key={portfolio.id}
                className={`
                  flex h-[48px] shrink-0 items-center gap-2 rounded-full px-3
      ...
      <button
        ...
        className="shrink-0 flex items-center gap-2 text-sm font-medium text-muted-foreground transition-all duration-200 hover:text-foreground hover:translate-x-0.5 cursor-pointer"
      >
